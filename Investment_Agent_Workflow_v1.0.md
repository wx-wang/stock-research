# Investment Agent Workflow v1.0
...
Agent 先运行 Market Regime、Industry Thesis 和 Profit Pool。在明确价值流向后形成候选公司，再对每个候选公司分别继续 Company Alpha 及其后续阶段。
...
Investment Agent Workflow v1.0 的核心是：
